...
# IMPORTANT:
# - If you use a Render Cron Job, set BACKGROUND_EVALUATOR=0 (default) to avoid SQLite contention.
# - If you are NOT using a Cron Job, set BACKGROUND_EVALUATOR=1 to run evaluator inside the web service.
