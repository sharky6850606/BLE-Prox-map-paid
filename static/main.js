...
const OFFLINE_THRESHOLD_SECONDS = 365 * 24 * 60 * 60;   // 20 minutes with 5 min sends (~4 missed updates)
const DISTANCE_ALERT_THRESHOLD_METERS = 3;   // "Far" if beyond 5m
...
async function fetchAndUpdateMapData() {
  try {
    ...
    const DISTANCE_ALERT_THRESHOLD_M = 3;
